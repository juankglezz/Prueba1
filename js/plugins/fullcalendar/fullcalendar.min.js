...
(function (t, e) {
    ...
    function a(n, r) {
        function a() {
            v = r.theme ? 'ui' : 'fc';
            var n = r.header;
            return n ? h = t('<table id="clandar2" onclick="repinta()" class=\'fc-header\' style=\'width:100%\'/>').append(t('<tr/>').append(i('left')).append(i('center')).append(i('right'))) : e
        }
    ...
    function o(n, r) {
        ...
        for (var E, S, T = M.trigger, x = M.getView, k = M.reportEvents, H = {
            events: []
                ...
                H
        ], R = 0, N = 0, z = 0, W = [], A = 0; r.length > A; A++)
            c(r[A])
    }
    ...
    function Z(e, n, r) {
        ...
        function v() {
            var t,
                ...
                r = le + '-widget-content',
                a = '';
            for (a += '<tbody class=\'calendario\'>', t = 0; ee > t; t++) {
                for (a += '<tr class=\'fc-week\'>', ue && (n = Ee(t, 0), a += '<td class=\'fc-week-number ' + r + '\'>' + '<div>' + q(xe(n, ve)) + '</div>' +
                    '</td>'), e = 0; ne > e; e++)
                    n = Ee(t, e),
                a += h(n);
                a += '</tr>'
        ...
        function h(t) {
            ...
            return t.getMonth() != n && o.push('fc-other-month'), +t == +r ? o.push('fc-today', le + '-state-highlight') : r > t ? o.push('fc-past') : o.push('fc-future'),
            a += '<td onclick=\'obtenerId(this.id);\'  data-toggle="modal" href="#modalEvento"  id=\'' + xe(t, 'yyyyMMdd') + '\' class=\'' + o.join(' ') + '\'' + ' data-date=\'' + xe(t, 'yyyy-MM-dd') + '\'' + '>' + '<div>',
            re && (a += '<div class=\'fc-day-number\'>' + t.getDate() + '</div>'),
            a += '<div class=\'fc-day-content\'><div style=\'position:relative;\'></div></div>' + '</div><div><table style=\'width:100%;font-size:12px\'><tbody id="eventos"></tbody></table></div></td>'
        }
        ...
        function g(e) {
            ...
            J.each(function (e, o) {
                ee > e && (a = t(o), a.find('> div ').css('min-height', (e == ee - 1 ? r - 335.5 : n - 50) - R(a)))
                //-335px para las semanas y -50 para los dias del mes, estos para ajustar al tamaño a una aproximacion del 100% de la pantalla del navegador
            })
        }
    ...
    function de() {
        ...
        function c(t) {
            ...
            e += ' class=\'' + o.join(' ') + '\'' + ' style=' + '\'' + 'position:absolute;' + 'left:' + t.left + 'px;' + i + '\'' + '>' + '<div class=\'fc-event-inner\'>', !r.allDay && t.isStart && (e += '<span class=\'fc-event-time\'>' + q(G(r.start, r.end, T('timeFormat'))) + '</span>'),
    ...
    function ge(t, e) {
        return e.rightCol - e.leftCol - (t.rightCol - t.leftCol) ||
